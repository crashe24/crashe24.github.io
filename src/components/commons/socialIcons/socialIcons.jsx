...
const SocialIcons = () => {
  return (
    <div className="my-5 flex items-center justify-center">
      <a
        href="www.linkedin.com/in/jorge-luis-leon-sarmiento-911822234"
        target="_blank"
      ...
      <a
        href="https://github.com/crashe24"
        target="_blank"
        rel="noopener noreferrer"
      ...
      <a
        href="https://www.instagram.com/crashe24?igsh=dTczOWV6aWZtc3Jr&utm_source=qr"
        target="_blank"
        rel="noopener noreferrer"
        className="mx-3 text-zinc-400 hover:text-[#69c7c7] drop-shadow-[1px_1px_0_#7836cf]"
